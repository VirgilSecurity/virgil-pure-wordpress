<div class="virgil-pure-global-section">
    <div class="virgil-pure-global-logo-container">
        ...
        <p class="virgil-pure-global-logo-text">
            ...
            renders stolen passwords useless even if your database has been compromised.
            Virgil Pure can be used with any database or login system that uses passwords,
            so it's accessible for a business of any industry or size.
            <a href="https://virgilsecurity.com/announcing-purekit/" target="_blank">Learn more about PureKit</a>
        </p>
    </div>
</div>